...
(yas-define-snippets 'coffee-mode
                     '(("unl" "${1:action} unless ${0:condition}" "unl" nil nil nil "/home/bruno/code/yasnippet-vim-snippets/snippets/coffee-mode/unl" nil nil)
                       ...
                       ("if" "if ${1:condition}\n  ${0:`yas-selected-text`}" "if" nil nil nil "/home/bruno/code/yasnippet-vim-snippets/snippets/coffee-mode/if" nil nil)
                       ...
                       ("eif" "else if ${1:condition}\n  ${0:`yas-selected-text`}" "eif" nil nil nil "/home/bruno/code/yasnippet-vim-snippets/snippets/coffee-mode/eif" nil nil)
