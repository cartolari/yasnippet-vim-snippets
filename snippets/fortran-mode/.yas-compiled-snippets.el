...
(yas-define-snippets 'fortran-mode
                     '(("write" "write(unit = ${1:fp}, file = ${2:filename}, iostat = ${3:ierr}) $0" "write" nil nil nil "/home/bruno/code/yasnippet-vim-snippets/snippets/fortran-mode/write" nil nil)
                       ...
                       ("read" "read(unit = ${1:fp}, file = ${2:filename}, iostat = ${3:ierr}) $0" "read" nil nil nil "/home/bruno/code/yasnippet-vim-snippets/snippets/fortran-mode/read" nil nil)
                       ...
                       ("open" "open(unit = ${1:fp}, file = ${2:filename}, status = ${3:unknown}, iostat = ${4:ierr}) $0" "open" nil nil nil "/home/bruno/code/yasnippet-vim-snippets/snippets/fortran-mode/open" nil nil)
                       ...
                       ("doxp" "!> @param[$1]$0" "doxp" nil nil nil "/home/bruno/code/yasnippet-vim-snippets/snippets/fortran-mode/doxp" nil nil)
                       ("dox" "!> @brief $1\n!!\n!> $2\n!> @author `\"Name\"`\n$0" "dox" nil nil nil "/home/bruno/code/yasnippet-vim-snippets/snippets/fortran-mode/dox" nil nil)
                       ...
                       ("arr" "${1:type}, ${2:allocatable, }dimension(${3::}) :: $0" "arr" nil nil nil "/home/bruno/code/yasnippet-vim-snippets/snippets/fortran-mode/arr" nil nil)
