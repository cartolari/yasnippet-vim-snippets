...
(yas-define-snippets 'sh-mode
                     '(("wh" "while [[ ${1:condition} ]]; do\n  ${0:`yas-selected-text`}\ndone" "wh" nil nil nil "/home/bruno/code/yasnippet-vim-snippets/snippets/sh-mode/wh" nil nil)
                       ...
                       ("sbash" "#!/usr/bin/env bash\nset -euo pipefail\nIFS=$'\\n\\t'\n" "sbash" nil nil nil "/home/bruno/code/yasnippet-vim-snippets/snippets/sh-mode/sbash" nil nil)
                       ...
                       ("elif" "elif [[ ${1:condition} ]]; then\n  ${0:`yas-selected-text`}" "elif" nil nil nil "/home/bruno/code/yasnippet-vim-snippets/snippets/sh-mode/elif" nil nil)
